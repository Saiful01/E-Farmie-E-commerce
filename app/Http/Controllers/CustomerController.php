...
class CustomerController extends Controller
{
    ...
    public function cart()
    {
        ...
        if (Session::get('customer_id')) {
            return view('farmie.pages.cart.index')
        ...
        if ($flag) {
            ...
            try {
               ...
               // $this->sendSms($request['customer_name'], $request['customer_phone'],$invoice);
                ...
                //return back()->with('success', "Successfully save your Order");
    ...
    {
        return view('farmie.pages.auth.registration')
    ...
    {
        return view('farmie.pages.auth.login')
            ->with('categories', Category::orderBy('created_at', 'DESC')->limit(10)->get());
