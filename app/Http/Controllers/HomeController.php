...
class HomeController extends Controller
{
    public function home(){
        $featured_item = Product::where('featured_product', true)->where('publish_status', true)
        ->orderBy('created_at', 'DESC')->limit(4)->get();
        $blogs= Blog::orderBy('created_at', 'DESC')->limit(6)->get();


        return view('farmie.pages.home.home')
    ...
    public function blog(){
      /*  join('blog_categories', 'blog_categories.blog_category_id', '=', 'blogs.blog_category_id')*/
       $blogs= Blog::orderBy('created_at', 'DESC')
            ->paginate(5);
        return view('farmie.pages.home.blog')
            ->with('blogs',$blogs)
    ...
    public function blogDetails( $id){
       $comments = Comment::where('blog_id', $id)
         ...
         ->join('bloggers', 'bloggers.blogger_id', '=', 'blogs.blogger_id')
         ->first();
        return view('farmie.pages.home.blog_details')
            ->with('comments',$comments)
            ->with('blog',$blog);
    }
    public function blogCategorySearch( $id){
       $blogs= Blog::join('blog_categories', 'blog_categories.blog_category_id', '=', 'blogs.blog_category_id')
    ...
    public function contactstore(Request $request)
    {
        ...
        try {
            ...
            return back()->with('success', "Successfully Send Your Message");
        }
    ...
    public function aboutfarmie(){
        return view('farmie.pages.home.about');
    }
    public function contactfarmie(){
        return view('farmie.pages.home.contact');
    }
    public function allLogin(){
        return view('all_login');
    }
    public function allregistration(){
        return view('all_registration');
    }
    public function product(){
        $featured_item = Product::where('featured_product', true)->where('publish_status', true)->limit(4)->get();
        ...
        return view('farmie.pages.home.product')
    ...
    public function categiriseProducts($id)
    {
        ...
        return view('farmie.pages.home.category_post.index')
            ->with('categories', Category::orderBy('created_at', 'DESC')->limit(10)->get())
