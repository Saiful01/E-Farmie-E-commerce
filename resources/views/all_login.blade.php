    ...
    <div class="row justify-content-center  ">
        ...
        <div class="col-3 rounded border shadow p-3 m-5 bg-white " id="col-Login">
            ...
            <div class="text-center" >
                <a style="width: 300px" class="btn btn-big btn-primary" href="/customer/login">কাস্টমার লগ ইন</a>
            </div>
        ...
        <div class="col-3 rounded border shadow p-3 m-5 bg-white " id="col-Login">
            ...
            <div class="text-center" >
                <a style="width: 300px" class="btn btn-big btn-success" href="/blogger/login">ব্লগার লগ ইন</a>
            </div>
            <div class="text-center mt-3" >
        ...
        <div class="col-3 rounded border shadow p-3 m-5 bg-white " id="col-Login">
            ...
            <div class="text-center" >
                <a style="width: 300px" class="btn btn-big btn-danger" href="/admin/login">অ্যাডমিন লগ ইন</a>
            </div>
