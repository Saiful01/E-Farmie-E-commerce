...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box"><h4 class="page-title">Blog Edit</h4>
                <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card m-b-20">
                ...
                <div class="card-body"><h4 class="mt-0 header-title"> Edit Blog </h4>
                    ...
                    <form method="post" action="/admin/blog/update" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="blog_title" value="{{$result->blog_title}}">
                                <input class="form-control" type="hidden" name="_token" value="{{csrf_token()}}">
                                <input class="form-control" type="hidden" name="blog_id" value="{{$result->blog_id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" type="text" name="blog_details">{{ $result->blog_details}} </textarea>
