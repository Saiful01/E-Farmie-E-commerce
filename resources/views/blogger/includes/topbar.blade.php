<div class="topbar"><!-- LOGO -->
    <div class="topbar-left"><a href="/blogger/dashboard" class="logo"><span style="color:#fff">Blogger </span><i><img
            ...
            <li class="dropdown notification-list">
                <div class="dropdown notification-list nav-pro-img"><a
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown"><!-- item--> <a
                        ...
                        <a class="dropdown-item text-danger" href="/blogger/logout"><i
